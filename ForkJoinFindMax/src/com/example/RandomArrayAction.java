    ...
    public void compute() {
        ...
        if (end - start < threshold){ 
            for (int i = start; i <= end; i++) {
                 ...
                 * escala cuando se ejecuta simultaneamente con varios threads y eliminaría cualquier
                 * ventaja de aplicar el marco Fork-join.
                 */
                myArray[i] = ThreadLocalRandom.current().nextInt();    // * se inicializa la matriz
            }
        } else {
            // * Cuando es mayor al umbral se debe encontrar un punto intermedio como se verá 
            // * A continuación
            ...
            // * Con la función invokeAll en lugar de la combinación de fork/join/compute del antiguo caso
            // * Se pueden ejecutar los dos procesos simultaneamente.
